...
[![Статус сборки](https://repology.илиg/badge/vertical-allrepos/niri.svg)](https://repology.org/project/niri/versions)
...
Далее, см. [список важного ПО](#), необходимых для нормального использования
...
1. Установите зависимости для вашего дистрибутива:
    ...
    <Tabs>
        <TabItem label="Ubuntu 23.10">
            ```shell sudo apt-get install -y gcc clang libudev-dev libgbm-dev
            libxkbcommon-dev libegl1-mesa-dev libwayland-dev libinput-dev
            libdbus-1-dev libsystemd-dev libseat-dev libpipewire-0.3-dev
            libpango1.0-dev ```
        </TabItem>
        <TabItem label="Fedora">
            ```shell sudo dnf install gcc libudev-devel libgbm-devel
            libxkbcommon-devel wayland-devel libinput-devel dbus-devel
            systemd-devel libseat-devel pipewire-devel pango-devel
            cairo-gobject-devel clang ```
        </TabItem>
    </Tabs>
